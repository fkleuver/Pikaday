System.register(["./options"], function (exports_1, context_1) {
    ...
    var options_1, hasEventListeners, document, sto, Pikaday;
    return {
        setters: [
        ...
        execute: function () {
            ...
            Pikaday = /** @class */ (function () {
                ...
                Pikaday.prototype.config = function (options) {
                    if (!this.opts) {
                        this.opts = extend({}, options_1.defaultOptions, true);
                    }
                    ...
                    if (isArray(opts.yearRange)) {
                        ...
                        opts.yearRange = Math.abs(parseInt(opts.yearRange, 10)) || options_1.defaultOptions.yearRange;
                ...
                Pikaday.prototype.setMinDate = function (value) {
                    if (value instanceof Date) {
                        ...
                        this.opts.minDate = options_1.defaultOptions.minDate;
                        this.opts.minYear = options_1.defaultOptions.minYear;
                        this.opts.minMonth = options_1.defaultOptions.minMonth;
                        this.opts.startRange = options_1.defaultOptions.startRange;
                    }
                    this.draw();
                };
                /**
                ...
                Pikaday.prototype.setMaxDate = function (value) {
                    if (value instanceof Date) {
                        ...
                        this.opts.maxDate = options_1.defaultOptions.maxDate;
                        this.opts.maxYear = options_1.defaultOptions.maxYear;
                        this.opts.maxMonth = options_1.defaultOptions.maxMonth;
                        this.opts.endRange = options_1.defaultOptions.endRange;
                    }
                    this.draw();
                };
